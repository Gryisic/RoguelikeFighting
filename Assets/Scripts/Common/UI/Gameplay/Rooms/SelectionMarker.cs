...
namespace Common.UI.Gameplay.Rooms
{
    public class SelectionMarker : UIElement
    {
        ...
        private const float ScaleModifier = 1.4f;
        ...
        public void Expand()
        {
            ...
            _type.fontSize = _initialTypeTextSize * ScaleModifier;

            DOTween.Sequence()
                .Append(_icon.DOFade(0f, 0.3f))
                .Append(_icon.rectTransform.DOScale(_initialIconScale * ScaleModifier, 0f))
